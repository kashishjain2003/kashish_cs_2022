...
ttk.Button(app, text='ye wala bhi h', font=('Arial', 22),
           command=lambda: msg.set('pta nhi')).place(x=50, y=150)
...
ttk.Button(app, text='-', command=lambda: calci('-'),
           font=('Arial', 22)).place(x=100, y=260)
ttk.Button(app, text='*', command=lambda: calci('*'),
           font=('Arial', 22)).place(x=150, y=260)
ttk.Button(app, text='/', command=lambda: calci('/'),
           font=('Arial', 22)).place(x=200, y=260)
